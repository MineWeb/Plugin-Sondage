    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Créer un sondage</h2>
            </div>
            <div class="card-body">
...
<script>
    $(document).ready(function() {
        $('.btn-add-cmd').click(function() {
            ...
            input += '<button class="btn btn-danger delete-resp" data-id="' + i + '" type="button"><span class="fa fa-times" style="margin-right: 1.5px;margin-left: 1.5px;"></span></button>';
            input += '</span>';
            input + '</div>';
